...
Route::get('/stats/results/overview/{id}', array('as' => 'statsresultsoverview', 'uses' => 'StatsResults@overview'));
...
Route::get('/user/form', array('before' => 'auth', 'as' => 'user form', 'uses' => 'UserForm@showForm'));
Route::post('/user/formsave', array('before' => 'auth', 'as' => 'user form save', 'uses' => 'UserForm@saveForm'));
Route::get('/user/overview', array('before' => 'auth', 'as' => 'user overview', 'uses' => 'UserOverview@showOverview'));
